...
![Applications 화면](/discord-py-bot/2023-03-02-discord-py-bot-1/01-01.png){:style=""}
...
![New Application 버튼](/discord-py-bot/2023-03-02-discord-py-bot-1/01-02.png)
...
![Applications 정보 화면](/discord-py-bot/2023-03-02-discord-py-bot-1/02-01.png)

여기서 좌측 **SETTING** 메뉴의 밑에 있는 **Bot** 카테고리를 클릭하고

![Applications 봇 추가 화면](/discord-py-bot/2023-03-02-discord-py-bot-1/02-02.png)
...
![Applications 봇 정보 화면](/discord-py-bot/2023-03-02-discord-py-bot-1/02-03.png)

<br>

## 2.1. 봇 상세설정

![봇 설정 이미지](/discord-py-bot/2023-03-02-discord-py-bot-1/02-01-01.png)
...
![변경 후 Applications 봇 정보 화면](/discord-py-bot/2023-03-02-discord-py-bot-1/03-01.png)

여기서 다시 좌측 **SETTING** 메뉴의 밑에 있는 **OAuth2** 카테고리를 클릭하고, **URL Generator** 를 클릭합니다.

그러면 밑과 같은 화면이 뜨는데요.

![OAuth2 화면](/discord-py-bot/2023-03-02-discord-py-bot-1/03-02.png)
...
![OAuth2 링크](/discord-py-bot/2023-03-02-discord-py-bot-1/03-03.png)

이 링크를 복사해 새 탭의 주소창에 입력 해 주세요.

![봇 초대 화면1](/discord-py-bot/2023-03-02-discord-py-bot-1/03-04.png)
