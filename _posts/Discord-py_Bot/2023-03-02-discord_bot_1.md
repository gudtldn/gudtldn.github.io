...
![Applications 화면](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/1.1.png){:style=""}
...
![New Application 버튼](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/1.2.png)
...
![Applications 정보 화면](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/2.1.png)

여기서 좌측 **SETTING** 메뉴의 밑에 있는 **Bot** 카테고리를 클릭하고

![Applications 봇 추가 화면](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/2.2.png)
...
![Applications 봇 정보 화면](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/2.3.png)

<br>

## 2.1. 봇 상세설정

![봇 설정 이미지](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/2.1.1.png)
...
![변경 후 Applications 봇 정보 화면](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/3.1.png)

여기서 다시 좌측 **SETTING** 메뉴의 밑에 있는 **OAuth2** 카테고리를 클릭하고, **URL Generator** 를 클릭합니다.

그러면 밑과 같은 화면이 뜨는데요.

![OAuth2 화면](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/3.2.png)
...
![OAuth2 링크](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/3.3.png)

이 링크를 복사해 새 탭의 주소창에 입력 해 주세요.

![봇 초대 화면1](/assets/images/Discord-py_Bot/2023-03-02-discord-py_bot_1/3.4.png)
