...
![디코 사용자 설정 화면](/discord-py-bot/2023-03-16-discord-py-bot-4/01-01.png)

그리고 빗금 명령어를 사용하고 싶은 서버를 마우스 오른쪽 클릭을 하고 `ID 복사하기` 버튼을 눌러주세요.

![서버 id 복사하는 사진](/discord-py-bot/2023-03-16-discord-py-bot-4/01-02.png)
...
![명령어 목록 사진](/discord-py-bot/2023-03-16-discord-py-bot-4/02-01.png)
![명령어 실행 결과 사진](/discord-py-bot/2023-03-16-discord-py-bot-4/02-02.png)
...
![명령어 목록 사진](/discord-py-bot/2023-03-16-discord-py-bot-4/03-01.png)
![매개변수 명령어 입력 사진](/discord-py-bot/2023-03-16-discord-py-bot-4/03-02.png)
![매개변수 명령어 결과 사진](/discord-py-bot/2023-03-16-discord-py-bot-4/03-03.png)
...
![예외 발생 결과 사진](/discord-py-bot/2023-03-16-discord-py-bot-4/04-01.png)
