...
![cmd pip 없음 사진](/python/2023-03-02-python-pip-install/01-01.png)
...
![python 검색사진](/python/2023-03-02-python-pip-install/02-01-01.png)

그러면 다음과 같은 창이 뜨는데,

![python 바로가기 폴더 사진](/python/2023-03-02-python-pip-install/02-01-02.png)

여기서 한번 더 `파일 위치 열기` 를 클릭합니다.

![python이 있는 폴더 사진](/python/2023-03-02-python-pip-install/02-01-03.png)

위와 같은 창이 나오면, 폴더의 경로를 복사합니다.

다시 윈도우 검색창으로 가서 **path** 를 적고 **시스템 환경 번수 편집** 을 클릭합니다.

![path 검색 사진](/python/2023-03-02-python-pip-install/02-01-04.png)

그러면 아래와 같은 창이 뜨는데,

![시스템 속성 창 사진](/python/2023-03-02-python-pip-install/02-01-05.png)

여기서 우측 하단에 있는 `환경 변수` 를 누르고,

![환경 변수창 사진](/python/2023-03-02-python-pip-install/02-01-06.png)

하단에 **시스템 변수** 카테고리에서 변수명이 **Path** 인 값을 찾아 `편집` 을 클릭합니다.

![환경 변수 편집창 사진](/python/2023-03-02-python-pip-install/02-01-07.png)
